...
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=1, column=1)
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=1, column=2)
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=2, column=0)
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=2, column=1)
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=2, column=2)
...
Button(calculator, text=" 1 ", height=1, width=7, command=lambda: press(1)).grid(row=3, column=2)
