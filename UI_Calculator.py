...
equation = StringVar()
Entry(calculator, textvariable=equation, width=76, state=DISABLED, bg="white").grid(row=0, column=0, columnspan=3, padx=15, pady=12)
...
Button(calculator, text=" + ",font=(BOLD, 16), height=2, width=12, command=lambda: press(1)).grid(row=4, column=0, pady=5)
Button(calculator, text=" - ",font=(BOLD, 16), height=2, width=12, command=lambda: press(1)).grid(row=4, column=2, pady=5)
Button(calculator, text=" * ",font=(BOLD, 16), height=2, width=12, command=lambda: press(1)).grid(row=5, column=2, pady=5)
Button(calculator, text=" / ",font=(BOLD, 16), height=2, width=12, command=lambda: press(1)).grid(row=5, column=0, pady=5)
Button(calculator, text=" = ",font=(BOLD, 16), height=2, width=12, command=lambda: press(1)).grid(row=5, column=1, pady=5)
Button(calculator, text=" CLEAR ",font=(BOLD, 16), height=3, width=12, command=lambda: press(1)).grid(row=6, column=2)
Button(calculator, text=" BACKSPACE ",font=(BOLD, 16), height=3, width=12, command=lambda: press(1)).grid(row=6, column=1)
calculator.mainloop()